    ...
    if (isset($_POST["save"])) {
        $selected_stamp_filename = isset($_POST['stamp_image_path']) ? $_POST['stamp_image_path'] : '';
    ...
    quotation_date = ?, Company_name = ?, Cname = ?, Cphone = ?, Caddress = ?, Cmail = ?, Cgst = ?, Note = ?, payment_details_type = ?, selected_stamp_filename = ?
    WHERE Sid = ?";
