                 ...
                 <ul class="navbar-nav " style="margin-left: 10%; text-align: center;">
                     ...
                     <li class="nav-item ">
                         <a class="nav-link text-dark nav-links" href="report.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                             ...
                             </svg> Need to Follow</a>
                     </li>

                     <li class="nav-item">
                         <a class="nav-link text-dark nav-links" href="income_chart.php">
                             <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-bar-chart-line" viewBox="0 0 16 16">
                                 <path d="M0 0h1v15h15v1H0V0z" />
                                 <path d="M10 10h1v3h-1v-3zm-4-5h1v8H6V5zm2 3h1v5H8V8z" />
                             </svg>
                             Income Graph
                         </a>
                     </li>
