          ...
          <div class="container-fluid">
            ...
            <div class=" navbar-collapse  " id="navbarNav">
              <ul class="navbar-nav " style="margin-left: 10%; text-align: center;">
                ...
                <li class="nav-item ">
                  <a class="nav-link  nav-links active-link" href="viewcustomers.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 21 20" fill="none">
      ...
      <section class="col-lg-10">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-2 card card-customer">
              <div class=" text-ceneter ps-5 pt-5">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#007BFF" class="bi bi-receipt" viewBox="0 0 16 16">
