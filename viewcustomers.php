          ...
          <div class="row">
            <div class="col-lg-7 col-sm-12 pb-4">
              ...
              <div class="container  " style="border-radius: 50px;">
                ...
                <div id="chartContainer" style="height: 150px; border-radius: 20px;"></div>
              </div>
        ...
        <div class="container mango mt-2">
          <div class="" style="max-height: 500px; overflow-y: auto; border-radius: 40px; background-color: white;">
            ...
            <div class="table-responsive">
              ...
              <table class="table  table-striped table-hover  viewinvoicetable pb-5" id="invoice_table" style="border-collapse: collapse; border: none; border-radius: 40px;">
